...
$code = str_replace('[[i]]', sprintf('%0' . $data->i_digit . 'd', $i), $code);
...
$pdf->setColor('text', $r, $g, $b);
$html = "<span style='font-weight:{$data->name_weight}'>นายทดสอบ เกียรติบัตร</span>";
...
if ($data->line >= 2) {
    ...
    $pdf->setColor('text', $r, $g, $b);
    $html = "<span style='font-weight:{$data->line2_weight}'>ผ่านการอบรมการใช้งานระบบเกียรติบัตรออนไลน์</span>";
...
if ($data->line >= 3) {
    ...
    $pdf->setColor('text', $r, $g, $b);
    $html = "<span style='font-weight:{$data->line3_weight}'>สถาบันกวดวิชา ครูเอฟฟิสิกส์</span>";
