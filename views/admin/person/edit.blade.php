...
@section('content')
 ...
 <div class="rounded shadow bg-white text-dark p-4 fw-bold mt-4">
  ...
  <form method="POST" action="/admin/list.php?mode=update&cid={{ $cert->id }}&id={{ $data->id }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
   <div class="mx-auto col-md-8">
    ...
    <div class="row mb-3">
     ...
     <div class="col-sm-9">
      <input type="text" name="line2" id="line2" value="{{ old('line2', $data->line2) }}" class="form-control @error('line2') is-invalid @enderror">
     </div>
    </div>
    ...
    <div class="row mb-3">
     ...
     <div class="col-sm-9">
      <input type="text" name="line3" id="line3" value="{{ old('line3', $data->line3) }}" class="form-control @error('line3') is-invalid @enderror">
     </div>
    </div>
    ...
    <div class="row mb-3">
     ...
     <div class="col-sm-9">
      <input type="number" step="1" name="i" id="i" value="{{ old('i', $data->i) }}" class="form-control @error('i') is-invalid @enderror" required>
     </div>
    </div>
